...
const ScheduleClassPage: React.FC<ScheduleClassPageProps> = ({ isMobileMenuOpen, setIsMobileMenuOpen }) => {
      ...
      <div className="flex-1 md:ml-64 w-full">
        ...
        >
          ...
          <div className="w-full md:w-auto">
            <h1
              className="text-xl md:text-3xl font-bold text-gray-900 mb-0.5 md:mb-1 leading-tight"
              style={{
                fontFamily: FONT_FAMILY,
              }}
            >
