...
import { TextField, Select, MenuItem, FormControl, Checkbox, FormControlLabel, SelectChangeEvent } from "@mui/material";
...
const ApplyNowCoordinatorSection: React.FC = () => {
  ...
  return (
    <section className="py-12 md:py-16 lg:py-20 bg-white">
      <div className="mx-auto w-full px-4 sm:px-6 lg:px-12 xl:px-20 2xl:px-24">
        <SectionHeader
          title="Apply Now - Coordinator Registration"
          subtitle="Fill out the form below to start your earning journey"
          variant="default"
          bottomMargin="lg"
        />
...
export default ApplyNowCoordinatorSection;
