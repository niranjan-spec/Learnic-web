...
const CoordinatorHero: React.FC = () => {
  return (
    <section 
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="text-white">
            <h1 className="mb-6 leading-tight" style={styles.heading}>
              Become a Learnic Coordinator & Start Earning.
            </h1>
            <p className="mb-8 leading-relaxed" style={styles.description}>
              Join our ever-growing network of coordinators and start earning money every month without any hassle.
            </p>
            <Button
              variant="primary"
              size="lg"
