        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div>
            <h1 className="text-white mb-6 leading-tight" style={styles.heading}>
              Join the Learnic Team
            </h1>
            <p
              className="text-white mb-8 leading-relaxed"
              style={styles.description}
            >
              Be part of a mission to make education smarter, simpler, and more accessible through live classes, recorded lessons, and expert-led modules.
            </p>
            <Link href="#openings">
              <Button
                type="button"
