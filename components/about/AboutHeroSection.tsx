      ...
      <div className="mx-auto w-full px-4 sm:px-6 lg:px-12 xl:px-20 2xl:px-24">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div>
            ...
            >
              At Learnic, we make education accessible, interactive, and engaging
              with live classes, recorded videos, and test series designed for
              every learner.
            </p>
            <Link href="/videos">
              <Button
          ...
          <div className="hidden lg:block relative w-full h-80 lg:h-96">
            <Image
              src="/images/banners/aboutUs1.svg"
              alt="About Learnic"
              fill
